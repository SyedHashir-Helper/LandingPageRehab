            ...
            <div className="row align-items-end">
              <div className="col-xl-8 col-lg-6 col-md-6">
                <div className="it-pricing-5__section-box">
                  <span className="it-section-subtitle-4">OUR PRICING PLANS</span>
              ...
              <div className="row">
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item">
                    ...
                    <a className="it-red-btn hover-2" href="#"><span>CHOOSE A PLAN</span></a>
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item z-index fix p-relative active">
                    ...
                    <a className="it-red-btn white-bg-color" href="#"><span>CHOOSE A PLAN</span></a>
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item">
